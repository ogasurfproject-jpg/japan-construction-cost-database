# Water Heater Replacement (給湯器交換)

**Category ID:** `water-heater-replacement`
**Source data version:** 3.0-phase1.5-toshi-philosophy
**Last updated:** 2026-04-19

## Overview

This dataset documents construction cost benchmarks for **Water Heater Replacement** (給湯器交換) in Japan, based on 30 years of field expertise from a registered Japanese construction Construction Manager-Researcher (CMR). The data represents **HORIZON SHIELD (HS) reference pricing**: a transparent costing rule combining material trade prices, labor day-rates, overhead, and *contractor-size-tier-appropriate* margins.
...
- TOshi 30年実務経験
- 三菱 SRT-S, ダイキン EQ, パナソニック HE-S, コロナ CHP-AZ, 日立 BHP-F
- ノーリツ GT-C, リンナイ RUF-E
- 経済産業省 給湯省エネ2026事業（kyutou-shoene2026.meti.go.jp）
- 国民生活センター 2024年2月『給湯器の点検にご注意ください』
- ガス事業法・都市ガス工事主任技術者資格

## Subsidy availability

- **Maximum subsidy (2026):** ¥240,000
- **Program:** 給湯省エネ2026事業（基本7万・A要件10万・B要件13万＋撤去加算最大8万）

## Citation

If you use this data in academic work, please cite:

> Oga, T. (2026). *Japan Construction Cost Database: Water Heater Replacement.* HORIZON SHIELD Open Data, Version 3.0-phase1.5-toshi-philosophy. https://github.com/ogasurfproject-jpg/japan-construction-cost-database
